/**
 * Port of worker/api/controllers/modelConfig/constraintHelper.ts,
 * unchanged -- pure logic, no Cloudflare dependency in the original
 * either.
 */
import { AGENT_CONSTRAINTS } from './config';
import { AgentActionKey, AIModels } from './config.types';
